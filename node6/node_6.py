...
class node_6(): 
    ...
    def decision_coordination(self, DSmode,var):
        x_fdj_list = var['x_fdj'].select('*', 'D2', '*')
        x_dcj_list = var['x_dcj'].select('D2', '*', '*')
        f6t3 = var['x_fdj'].select('F1', 'D2', '*')
        f6t4 = var['x_fdj'].select('F2', 'D2', '*')
