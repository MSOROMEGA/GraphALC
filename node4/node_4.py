...
class node_4(): 
    ...
    def decision_coordination(self, DSmode,var):
        x_sfj_list = var['x_sfj'].select('*', 'F2', '*')
        x_fdj_list = var['x_fdj'].select('F2', '*', '*')
        zm1_ffj_list = var['zm1_ffj'].select('*', '*', '*')
        zm2_ffj_list = var['zm2_ffj'].select('*', '*', '*')
        f4t1 = var['x_sfj'].select('S1', 'F2', '*')
        f4t2 = var['x_sfj'].select('S2', 'F2', '*')
        f4t3 = zm1_ffj_list + zm2_ffj_list
        f4t5 = var['x_fdj'].select('F2', 'D1', '*')
        f4t6 = var['x_fdj'].select('F2', 'D2', '*')
