...
class node_2(): 
    ...
    def decision_coordination(self, DSmode,var):
        x_sfj_list = var['x_sfj'].select('S2', '*', '*')
        zp1_ssj_list = var['zp1_ssj'].select('*', '*', '*')
        zp2_ssj_list = var['zp2_ssj'].select('*', '*', '*')
        x_23j_list = var['x_sfj'].select('S2', 'F1', '*')
        x_24j_list = var['x_sfj'].select('S2', 'F2', '*')
        if DSmode == 'CC': # Centralized coordination            
            ...
            # send_column
            cs1 = [i for i in zp1_ssj_list+zp2_ssj_list]
            cs2 = []
            cs3 = [i for i in x_23j_list]
            cs4 = [i for i in x_24j_list]
            cs5 = []
            cs6 = []
            cs7 = []
            # receive_column
            cr1 = [i for i in zp1_ssj_list+zp2_ssj_list]
            cr2 = []
            cr3 = [i for i in x_23j_list]
            cr4 = [i for i in x_24j_list]
            cr5 = []
            cr6 = []
            cr7 = []
        elif DSmode == 'BPSC': # Bidirectional partially symmetric coordination            
            # send_column
            cs1 = zp1_ssj_list + zp2_ssj_list
            cs2 = []
            cs3 = [x_23j_list[0]]
            cs4 = [x_24j_list[0]]
            cs5 = []
